...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Dictionary Matches")]
        [NUnit.Framework.CategoryAttribute("compiledRegex")]
        [NUnit.Framework.TestCaseAttribute("abc123def456", "(?<alpha>[a-z]+)(?<numeric>\\d+)", "alpha:abc;numeric:123", "alpha:def;numeric:456", null)]
        [NUnit.Framework.TestCaseAttribute("456.def123.abc", "(?<numeric>\\d+)\\.(?<alpha>[a-z]+)", "numeric:456;alpha:def", "numeric:123;alpha:abc", null)]
        public virtual void DictionaryMatches(string input, string pattern, string firstExpectedGroupValues, string secondExpectedGroupValues, string[] exampleTags)
        {
            string[] @__tags = new string[] {
                    "compiledRegex"};
            if ((exampleTags != null))
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Dictionary Matches", @__tags);
#line 37
this.ScenarioSetup(scenarioInfo);
#line 38
 testRunner.Given(string.Format("I have created a string equal to: {0}", input), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
...
#line 40
 testRunner.When("I retrieve a dictionary match of the string using the CompiledRegex", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 41
 testRunner.Then(string.Format("all expected group values ({0}) should be found in the first resulting dictionary" +
                        "", firstExpectedGroupValues), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 42
 testRunner.And(string.Format("all expected group values ({0}) should be found in the second resulting dictionar" +
                        "y", secondExpectedGroupValues), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            this.ScenarioCleanup();
        }
    }
